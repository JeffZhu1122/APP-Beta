...
$frames = array('login', 'index', 'body', 'config', 'config_extend', 'app', 'key', 'make', 'cert', 'sign', 'secret', 'user', 'backup', 'sql', 'clean', 'update', 'admin', 'paylog', 'buylog', 'signlog', 'talk', 'ajax', 'module', 'develop');

					...
					<div class="field app-short">
						...
						<div class="value">
							<div class="apps-app-security">
								...
								<?php if($status && $status < 2){ ?><div class="btn-invite-member" style="margin-left:5px;border:1px solid #8B0000;color:#8B0000" onclick="reset_sign_confirm()">签名长时间无响应，请点此重置</div><?php } ?>
							</div>
						</div>
					</div>

					...
					<div class="field app-name">
						...
						<div class="value">
							<div class="input-group">
								...
								<input type="text" class="form-control" value="<?php echo $row['in_link']; ?>" id="in_link" onkeyup="value=value.replace(/[\W|\_]/g,'')" onblur="value=value.replace(/[\W|\_]/g,'')"<?php if(IN_REWRITE == 0){echo ' placeholder="短链功能未开放！" readonly';} ?>>
							</div>
						</div>
					</div>
